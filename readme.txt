...
More descripcion ale located in test file "tresc zadania.pdf" 
...
1 4
1 5
- first number is number of measurements, second number is number of all childrens.
- second line defines all measurements that was made by only child, who done his task completly.
- third and all next lines defines the data of other childrens. 
